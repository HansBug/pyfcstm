...
| `event_input_path_name_object` | simulation, generated_python_alignment | ended, return, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>`test/template/python/test_semantic_fixture_alignment.py::test_generated_python_alignment_semantic_fixture` |
