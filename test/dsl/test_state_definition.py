...
class TestDSLTransition:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                StateDefinition(
                    name="parent",
                    extra_name="Parent State",
                    substates=[
                        StateDefinition(
                            name="child",
                            extra_name="Child State",
                            substates=[],
                            transitions=[],
                            enters=[],
                            durings=[],
            ...
            (
                ...
                StateDefinition(
                    name="complex",
                    extra_name="Complex State",
                    substates=[
                        StateDefinition(
                            name="sub1",
                            extra_name="Sub State 1",
                            substates=[],
                            transitions=[],
                            enters=[],
                            durings=[],
            ...
            (
                ...
                StateDefinition(
                    name="controlled",
                    extra_name="Controlled State",
                    substates=[],
                    transitions=[],
                    enters=[],
                    durings=[],
                    exits=[ExitAbstractFunction(name="cleanup", doc=None)],
                    during_aspects=[],
                    force_transitions=[],
                    is_pseudo=False,
                ),
            ...
            (
                ...
                StateDefinition(
                    name="MainState",
                    extra_name=None,
                    events=[EventDefinition(name="ButtonClick", extra_name=None)],
                    substates=[],
                    transitions=[],
                    enters=[],
                    durings=[],
            ...
            (
                ...
                StateDefinition(
                    ...
                    events=[
                        EventDefinition(
                            name="DataReceived", extra_name="Data Reception Event"
                        )
                    ],
                    substates=[],
                    transitions=[],
            ...
            (
                ...
                StateDefinition(
                    ...
                    extra_name=None,
                    events=[
                        EventDefinition(name="StartEvent", extra_name=None),
            ...
            (
                ...
                StateDefinition(
                    ...
                    events=[
                        EventDefinition(
                            name="ProcessComplete", extra_name="Processing Completed"
                        ),
                        EventDefinition(name="ErrorOccurred", extra_name=None),
                    ],
                    substates=[
                        StateDefinition(
                            name="SubState",
            ...
            (
                ...
                StateDefinition(
                    name="AlertState",
                    extra_name="Alert Handler",
                    events=[
                        EventDefinition(
                            name="WarningTriggered", extra_name="Warning Event"
                        )
                    ],
                    substates=[],
                    transitions=[],
            ...
            (
                ...
                StateDefinition(
                    ...
                    enters=[
                        ...
                        EnterRefFunction(
                            name="Second",
                            ref=ChainID(path=["root", "second"], is_absolute=True),
                        ),
                    ],
                    durings=[],
                    exits=[],
                ...
                StateDefinition(
                    ...
                    durings=[
                        ...
                        DuringRefFunction(
                            name="Second",
                            aspect="after",
                            ref=ChainID(path=["hooks", "second"], is_absolute=False),
                        ),
                    ],
                    exits=[
                        ExitOperations(
                    ...
                    during_aspects=[
                        DuringAspectOperations(
                            aspect="before",
                            operations=[
                                OperationAssignment(name="z", expr=Integer(raw="3"))
                            ],
                            name="Watch",
                        ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Composite state containing a simple import
            (
                """
                    state Imported named "Imported Root" {
                ...
                StateDefinition(
                    ...
                    events=[
                        EventDefinition(name="Ready", extra_name=None),
                    ],
                    transitions=[],
                    enters=[],
                    durings=[],
            ...
            # Composite state containing complex import, substate, and event definitions
        ],
    )
    def test_positive_cases_with_imports(self, input_text, expected):
        assert (
            parse_with_grammar_entry(input_text, entry_name="state_definition")
            == expected
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # State-definition string rendering preserves canonical import position
        ],
    )
    def test_positive_cases_str_with_imports(
        self, input_text, expected_str, text_aligner
    ):
        text_aligner.assert_equal(
            expect=expected_str,
            actual=str(
