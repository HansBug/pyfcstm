...
class GrammarParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by GrammarParser#import_mapping_statement.
    def enterImport_mapping_statement(
        self, ctx: GrammarParser.Import_mapping_statementContext
    ):
        pass

    # Exit a parse tree produced by GrammarParser#import_mapping_statement.
    def exitImport_mapping_statement(
        self, ctx: GrammarParser.Import_mapping_statementContext
    ):
        pass

    # Enter a parse tree produced by GrammarParser#import_def_mapping.
    def enterImport_def_mapping(self, ctx: GrammarParser.Import_def_mappingContext):
        pass

    # Exit a parse tree produced by GrammarParser#import_def_mapping.
    def exitImport_def_mapping(self, ctx: GrammarParser.Import_def_mappingContext):
        pass

    # Enter a parse tree produced by GrammarParser#importDefFallbackSelector.
    def enterImportDefFallbackSelector(
        self, ctx: GrammarParser.ImportDefFallbackSelectorContext
    ):
        pass

    # Exit a parse tree produced by GrammarParser#importDefFallbackSelector.
    def exitImportDefFallbackSelector(
        self, ctx: GrammarParser.ImportDefFallbackSelectorContext
    ):
        pass

    # Enter a parse tree produced by GrammarParser#importDefSetSelector.
    def enterImportDefSetSelector(self, ctx: GrammarParser.ImportDefSetSelectorContext):
        pass

    # Exit a parse tree produced by GrammarParser#importDefSetSelector.
    def exitImportDefSetSelector(self, ctx: GrammarParser.ImportDefSetSelectorContext):
        pass

    # Enter a parse tree produced by GrammarParser#importDefPatternSelector.
    def enterImportDefPatternSelector(
        self, ctx: GrammarParser.ImportDefPatternSelectorContext
    ):
        pass

    # Exit a parse tree produced by GrammarParser#importDefPatternSelector.
    def exitImportDefPatternSelector(
        self, ctx: GrammarParser.ImportDefPatternSelectorContext
    ):
        pass

    # Enter a parse tree produced by GrammarParser#importDefExactSelector.
    def enterImportDefExactSelector(
        self, ctx: GrammarParser.ImportDefExactSelectorContext
    ):
        pass

    # Exit a parse tree produced by GrammarParser#importDefExactSelector.
    def exitImportDefExactSelector(
        self, ctx: GrammarParser.ImportDefExactSelectorContext
    ):
        pass

    # Enter a parse tree produced by GrammarParser#import_def_target_template.
    def enterImport_def_target_template(
        self, ctx: GrammarParser.Import_def_target_templateContext
    ):
        pass

    # Exit a parse tree produced by GrammarParser#import_def_target_template.
    def exitImport_def_target_template(
        self, ctx: GrammarParser.Import_def_target_templateContext
    ):
        pass

    # Enter a parse tree produced by GrammarParser#import_event_mapping.
    def enterImport_event_mapping(self, ctx: GrammarParser.Import_event_mappingContext):
        pass

    # Exit a parse tree produced by GrammarParser#import_event_mapping.
    def exitImport_event_mapping(self, ctx: GrammarParser.Import_event_mappingContext):
        pass
