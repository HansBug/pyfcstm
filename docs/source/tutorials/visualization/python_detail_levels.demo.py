...
with open('output_python_minimal.puml', 'w', encoding='utf-8') as f:
...
with open('output_python_normal.puml', 'w', encoding='utf-8') as f:
...
with open('output_python_full.puml', 'w', encoding='utf-8') as f:
    f.write(full_output)
