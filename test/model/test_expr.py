...
class TestModelExpr:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "a + b",
                BinaryOp(x=Variable(name="a"), op="+", y=Variable(name="b")),
            ),  # Addition of variables a and b
            (
                "x - y",
                BinaryOp(x=Variable(name="x"), op="-", y=Variable(name="y")),
            ),  # Subtraction of y from x
            (
                "p * q",
                BinaryOp(x=Variable(name="p"), op="*", y=Variable(name="q")),
            ),  # Multiplication of variables p and q
            (
                "m / n",
                BinaryOp(x=Variable(name="m"), op="/", y=Variable(name="n")),
            ),  # Division of m by n
            (
                "i % j",
                BinaryOp(x=Variable(name="i"), op="%", y=Variable(name="j")),
            ),  # Modulo operation of i by j
            (
                "2 ** 3",
                BinaryOp(x=Integer(value=2), op="**", y=Integer(value=3)),
            ),  # 2 raised to the power of 3
            (
                "a << 2",
                BinaryOp(x=Variable(name="a"), op="<<", y=Integer(value=2)),
            ),  # Left bit shift of a by 2 bits
            (
                "b >> 1",
                BinaryOp(x=Variable(name="b"), op=">>", y=Integer(value=1)),
            ),  # Right bit shift of b by 1 bit
            (
                "x & y",
                BinaryOp(x=Variable(name="x"), op="&", y=Variable(name="y")),
            ...
            (
                "p | q",
                BinaryOp(x=Variable(name="p"), op="|", y=Variable(name="q")),
            ),  # Bitwise OR of p and q
            (
                "m ^ n",
                BinaryOp(x=Variable(name="m"), op="^", y=Variable(name="n")),
            ),  # Bitwise XOR of m and n
            ("sin(x)", UFunc(func="sin", x=Variable(name="x"))),  # Sine of x
            (
                "cos(theta)",
                UFunc(func="cos", x=Variable(name="theta")),
            ),  # Cosine of theta
            ("sqrt(2)", UFunc(func="sqrt", x=Integer(value=2))),  # Square root of 2
            (
                "log(x)",
                UFunc(func="log", x=Variable(name="x")),
            ),  # Natural logarithm of x
            (
                "abs(-7)",
                UFunc(func="abs", x=UnaryOp(op="-", x=Integer(value=7))),
            ),  # Absolute value of -7
            (
                "(a + b)",
                BinaryOp(x=Variable(name="a"), op="+", y=Variable(name="b")),
            ),  # Parenthesized addition of a and b
            (
                "(x * y) + z",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="x"), op="*", y=Variable(name="y")),
                    op="+",
                    y=Variable(name="z"),
                ),
            ),
            ...
            (
                "(flag == 0x2) ? 1 : 0",
                ConditionalOp(
                    cond=BinaryOp(x=Variable(name="flag"), op="==", y=Integer(value=2)),
                    if_true=Integer(value=1),
                    if_false=Integer(value=0),
                ),
            ),  # If flag equals 0x2, return 1, otherwise return 0
            (
                "sin(x) + cos(y)",
                BinaryOp(
                    x=UFunc(func="sin", x=Variable(name="x")),
                    op="+",
                    y=UFunc(func="cos", x=Variable(name="y")),
                ),
            ),
            ...
            ),  # Natural logarithm of x squared plus 1
            (
                "(a & b) | (c & d)",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="a"), op="&", y=Variable(name="b")),
            ...
            (
                ...
                UFunc(
                    func="sqrt",
                    x=BinaryOp(
                        x=BinaryOp(x=Variable(name="x"), op="*", y=Variable(name="x")),
                        op="+",
            ...
            (
                "abs(x) + abs(y)",
                BinaryOp(
                    x=UFunc(func="abs", x=Variable(name="x")),
                    op="+",
                    y=UFunc(func="abs", x=Variable(name="y")),
                ),
            ),
                        ...
                        x=BinaryOp(
                            x=BinaryOp(
                                x=BinaryOp(
                                    x=Integer(value=2),
                                    op="*",
                                    y=Float(value=3.141592653589793),
                                ),
                                op="*",
                                y=Variable(name="f"),
                            ),
            ...
            (
                ...
                ConditionalOp(
                    cond=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="x"), op="**", y=Integer(value=2)
                            ),
                            op="+",
                            y=BinaryOp(
                                x=Variable(name="y"), op="**", y=Integer(value=2)
                            ),
                        ),
                        op="<=",
                        y=BinaryOp(x=Variable(name="r"), op="**", y=Integer(value=2)),
                    ),
                    if_true=Integer(value=1),
                    if_false=Integer(value=0),
                ),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(x=Variable(name="a"), op="<<", y=Integer(value=2)),
                        op="&",
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(
                            ...
                            op="+",
                            y=BinaryOp(
                                x=UFunc(func="cos", x=Variable(name="x")),
                                op="**",
                                y=Integer(value=2),
                            ),
                        ),
                        ...
                        y=BinaryOp(
                            ...
                            op="+",
                            y=BinaryOp(
                                x=UFunc(func="tan", x=Variable(name="y")),
                                op="**",
                                y=Integer(value=2),
                            ),
                        ),
                    ...
                    y=BinaryOp(
                        ...
                        op="+",
                        y=BinaryOp(
                            x=UFunc(func="tanh", x=Variable(name="z")),
                            op="**",
                            y=Integer(value=2),
                        ),
                    ),
            ...
            (
                ...
                BinaryOp(
                    ...
                    y=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="e"), op="+", y=Variable(name="f")
                            ),
                            op="*",
                            y=BinaryOp(
                                x=Variable(name="g"), op="-", y=Variable(name="h")
                            ),
                        ),
                        op="**",
            ...
            (
                ...
                BinaryOp(
                    ...
                    y=UFunc(
                        func="atan",
                        x=BinaryOp(x=Integer(value=2), op="*", y=Variable(name="y")),
                    ),
                ),
            ...
            (
                ...
                ConditionalOp(
                    ...
                    if_true=ConditionalOp(
                        cond=BinaryOp(
                            x=Variable(name="a"), op="<", y=Variable(name="b")
                        ),
                        if_true=Variable(name="p"),
                        if_false=Variable(name="q"),
                    ),
                    if_false=ConditionalOp(
                        cond=BinaryOp(
                            x=Variable(name="c"), op="<", y=Variable(name="d")
                        ),
                        if_true=Variable(name="m"),
                        if_false=Variable(name="n"),
                    ),
                ),
            ),
            ...
            (
                ...
                BinaryOp(
                    x=UFunc(
                        func="sin",
                        x=UFunc(func="cos", x=UFunc(func="tan", x=Variable(name="x"))),
                    ),
                    op="+",
                    y=UFunc(
                        func="log",
                        x=UFunc(
                            func="exp",
                            x=UFunc(
                                func="sqrt", x=UFunc(func="abs", x=Variable(name="y"))
                            ),
                        ),
                    ),
                ),
            ...
            (
                ...
                BinaryOp(
                    ...
                    op="<<",
                    y=BinaryOp(
                        x=BinaryOp(x=Variable(name="e"), op="+", y=Variable(name="f")),
                        op="%",
                        y=Integer(value=8),
                    ),
                ),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        ...
                        op="+",
                        y=BinaryOp(x=Variable(name="z"), op="**", y=Integer(value=2)),
                    ),
                    op="**",
                    y=Float(value=0.5),
                ),
            ...
            (
                ...
                ConditionalOp(
                    ...
                    if_false=BinaryOp(
                        x=BinaryOp(x=Variable(name="h"), op="-", y=Variable(name="i")),
                        op="/",
                        y=Variable(name="j"),
                    ),
                ),
                ...
                BinaryOp(
                    x=BinaryOp(
                        ...
                        y=UFunc(
                            func="exp",
                            x=BinaryOp(
                                x=UnaryOp(op="-", x=Variable(name="t")),
                                op="/",
                                y=Float(value=6.283185307179586),
                            ),
                        ),
                    ),
                    op="+",
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="x"), op="&", y=Integer(value=255)
                            ),
                            op="<<",
                            y=Integer(value=16),
                        ),
                        ...
                        y=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="y"), op="&", y=Integer(value=255)
                            ),
                            op="<<",
                            y=Integer(value=8),
                        ),
                    ...
                    op="|",
                    y=BinaryOp(x=Variable(name="z"), op="&", y=Integer(value=255)),
                ),
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "False",
                Boolean(value=False),
            ),  # Boolean literal False (alternative syntax)
            (
                "x > y",
                BinaryOp(x=Variable(name="x"), op=">", y=Variable(name="y")),
            ...
            (
                "(p > 0) and (q < 1)",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="p"), op=">", y=Integer(value=0)),
                    op="&&",
            ...
            (
                "(m == 0) or (n != 1)",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="m"), op="==", y=Integer(value=0)),
                    op="||",
            ...
            (
                ...
                ConditionalOp(
                    ...
                    if_true=Boolean(value=True),
                    if_false=Boolean(value=False),
                ),
            ),  # If x > 0, return true, otherwise return false
            (
                "x > 0 && y > 0",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="x"), op=">", y=Integer(value=0)),
            ...
            (
                "(x >= min) && (x <= max)",
                BinaryOp(
                    x=BinaryOp(x=Variable(name="x"), op=">=", y=Variable(name="min")),
                    op="&&",
            ...
            (
                ...
                BinaryOp(
                    ...
                    y=UnaryOp(
                        op="!",
                        x=BinaryOp(x=Variable(name="c"), op="==", y=Variable(name="d")),
                    ),
                ),
            ),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(x=Variable(name="temp"), op=">", y=Integer(value=100)),
                    op="||",
                    y=BinaryOp(
                        x=Variable(name="pressure"), op=">", y=Integer(value=200)
                    ),
                ),
            ),
            ...
            (
                ...
                ConditionalOp(
                    cond=BinaryOp(x=Variable(name="x"), op=">", y=Integer(value=0)),
                    if_true=BinaryOp(x=Variable(name="y"), op=">", y=Integer(value=0)),
                    if_false=BinaryOp(x=Variable(name="z"), op=">", y=Integer(value=0)),
                ),
            ),
            ...
            (
                ...
                BinaryOp(
                    ...
                    op="||",
                    y=BinaryOp(
                        x=BinaryOp(x=Variable(name="y"), op="!=", y=Integer(value=0)),
                        op="&&",
            ...
            (
                ...
                BinaryOp(
                    ...
                    op="||",
                    y=BinaryOp(
                        x=BinaryOp(x=Variable(name="i"), op=">", y=Variable(name="j")),
                        op="&&",
            ...
            (
                ...
                BinaryOp(
                    x=UnaryOp(
                        ...
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="x"), op="<", y=Variable(name="y")
                            ),
                            op="&&",
                            y=BinaryOp(
                                x=Variable(name="z"), op="<", y=Variable(name="w")
                            ),
                        ),
                    ),
                    op="||",
                    y=BinaryOp(
                        x=BinaryOp(x=Variable(name="p"), op="==", y=Variable(name="q")),
                        op="&&",
            ...
            (
                ...
                BinaryOp(
                    ...
                    y=ConditionalOp(
                        ...
                        if_true=BinaryOp(
                            x=Variable(name="i"), op="<", y=Variable(name="j")
                        ),
                        if_false=BinaryOp(
                            x=Variable(name="k"), op="<", y=Variable(name="l")
                        ),
                    ),
                ),
            ),
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(
                            ...
                            op="&&",
                            y=BinaryOp(
                                x=Variable(name="y"), op=">", y=Integer(value=0)
                            ),
                        ),
                        op="&&",
                        y=BinaryOp(x=Variable(name="z"), op=">", y=Integer(value=0)),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        ...
                        op="||",
                        y=BinaryOp(x=Variable(name="a"), op="==", y=Integer(value=3)),
                    ),
                    op="&&",
                    y=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="b"), op="==", y=Integer(value=1)
                            ),
                            op="||",
                            y=BinaryOp(
                                x=Variable(name="b"), op="==", y=Integer(value=2)
                            ),
                        ),
                        op="||",
            ...
            (
                ...
                BinaryOp(
                    ...
                    op="||",
                    y=BinaryOp(
                        x=BinaryOp(x=Variable(name="m"), op="==", y=Variable(name="n")),
                        op="&&",
            ...
            (
                ...
                ConditionalOp(
                    ...
                    if_false=BinaryOp(
                        ...
                        y=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="m"), op="<", y=Variable(name="n")
                            ),
                            op="||",
                            y=BinaryOp(
                                x=Variable(name="o"), op="<", y=Variable(name="p")
                            ),
                        ),
                    ),
                ),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="x"), op=">=", y=Variable(name="min")
                            ),
                            op="&&",
                            y=BinaryOp(
                                x=Variable(name="x"), op="<=", y=Variable(name="max")
                            ),
                        ),
                        op="||",
                        y=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="y"), op=">=", y=Variable(name="min")
                            ),
                            op="&&",
                            y=BinaryOp(
                                x=Variable(name="y"), op="<=", y=Variable(name="max")
                            ),
                        ),
                    ),
                    op="||",
                    y=BinaryOp(
                        x=BinaryOp(
                            x=Variable(name="z"), op=">=", y=Variable(name="min")
                        ),
                        op="&&",
                        y=BinaryOp(
                            x=Variable(name="z"), op="<=", y=Variable(name="max")
                        ),
                    ),
                ),
            ),
            ...
            (
                ...
                BinaryOp(
                    x=BinaryOp(
                        x=BinaryOp(
                            x=BinaryOp(
                                x=Variable(name="a"), op=">", y=Integer(value=0)
                            ),
                            op="&&",
                            y=BinaryOp(
                                x=Variable(name="b"), op=">", y=Integer(value=0)
                            ),
                        ),
                        op="||",
                        y=BinaryOp(
    ...
    def test_num_expression_parse_to_model_consistency(self, expr_text):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="num_expression")
        expr = parse_expr_node_to_expr(ast_node)
        ast_node_2 = parse_with_grammar_entry(
            str(expr.to_ast_node()), entry_name="num_expression"
        )
    ...
    def test_cond_expression_parse_to_model_consistency(self, expr_text):
        ...
        expr = parse_expr_node_to_expr(ast_node)
        ast_node_2 = parse_with_grammar_entry(
            str(expr.to_ast_node()), entry_name="cond_expression"
        )
        expr2 = parse_expr_node_to_expr(ast_node_2)
        assert pytest.approx(expr) == expr2

    @pytest.mark.parametrize(
        ["expr_text", "expected_variables"],
        [
            ("42", []),  # Integer literal 42
            ("3.14", []),  # Floating point literal 3.14
            ("0x2A", []),  # Hexadecimal integer literal 42
            ...
            (
                "p * q",
                [Variable(name="p"), Variable(name="q")],
            ),  # Multiplication of variables p and q
            ...
            (
                "m ^ n",
                [Variable(name="m"), Variable(name="n")],
            ),  # Bitwise XOR of m and n
            ...
            (
                "sin(2 * pi * f * t + phi)",
                [Variable(name="f"), Variable(name="t"), Variable(name="phi")],
            ),
            # Sine wave with frequency f, time t, and phase phi
            (
                "(x ** 2 + y ** 2 <= r ** 2) ? 1 : 0",
                [Variable(name="x"), Variable(name="y"), Variable(name="r")],
            ),
            # Check if point (x,y) is within circle of radius r
            (
                "log(abs(x) + sqrt(x ** 2 + 1))",
    ...
    def test_num_expression_parse_to_model_list_variables(
        self, expr_text, expected_variables
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="num_expression")
        expr = parse_expr_node_to_expr(ast_node)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "(x >= min) && (x <= max)",
                [Variable(name="x"), Variable(name="min"), Variable(name="max")],
            ),
            # Check if x is within range [min, max]
            (
                "!(a == b) && !(c == d)",
            ...
            (
                "(temp > 100) || (pressure > 200)",
                [Variable(name="temp"), Variable(name="pressure")],
            ),
            # Check if either temperature exceeds 100 or pressure exceeds 200
            (
                "x == y && y == z",
    ...
    def test_cond_expression_parse_to_model_list_variables(
        self, expr_text, expected_variables
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="cond_expression")
        expr = parse_expr_node_to_expr(ast_node)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "3 ** 2 ** 2",
                81,
            ),  # 3 raised to the power of (2 raised to the power of 2)
            ...
            (
                ...
                1.0,
            ),  # Sum of squared sine and cosine of pi/4
            (
                "(5 > 3 && 2 < 4) ? sqrt(16) : cbrt(27)",
                4.0,
            ),  # If both 5 > 3 and 2 < 4 then sqrt(16) else cbrt(27)
    ...
    def test_num_expression_parse_to_model_call_without_variables(
        self, expr_text, expected_value
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="num_expression")
        expr = parse_expr_node_to_expr(ast_node)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "(2 < 1) != (3 < 2)",
                False,
            ),  # Inequality comparison between two conditions
            ("true && true", True),  # Logical AND of two true values
            ("false || true", True),  # Logical OR of false and true
            (
                "true and false",
                False,
            ),  # Logical AND of true and false (alternative syntax)
            (
                "false or false",
                False,
            ),  # Logical OR of two false values (alternative syntax)
            ("(5 > 3) && (2 < 4)", True),  # Logical AND of two comparison expressions
            (
                "!(5 < 3) || (7 >= 10)",
                True,
            ),  # Logical OR of negated comparison and another comparison
            ("(true) ? false : true", False),  # If true then false else true
            (
                "(5 > 3) ? (2 == 2) : (1 != 1)",
                True,
            ),  # If 5 > 3 then check if 2 equals 2 else check if 1 not equals 1
            (
                "(3 * 4 > 10) && (20 / 5 == 4)",
                True,
            ),  # Logical AND of two complex comparisons
            (
                "(sin(pi/2) > 0.9) || (cos(0) < 0.5)",
                True,
            ),  # Logical OR of trigonometric function comparisons
            (
                "((5 > 3) && (2 < 4)) || ((1 == 1) && (0 != 1))",
                True,
            ),  # Nested logical operations with comparisons
            (
                "(true && false) || (true && true)",
                True,
            ),  # Combination of logical AND and OR operations
            (
                "(((5 > 3) && (2 < 4)) || ((1 == 1) && (0 != 1))) && (true || false)",
                True,
            ),
            ...
            (
                "!(5 < 3) && !(2 > 4) && (3 == 3)",
                True,
            ),  # Multiple negations combined with logical AND
            (
                "sqrt(16) == 4 && log10(1000) == 3",
                True,
            ),  # Comparisons involving mathematical functions
            (
                "(sin(0) ** 2 + cos(0) ** 2) == 1",
                True,
            ),  # Trigonometric identity comparison
            (
                "((5 * 3 > 10) && (20 / 5 == 4)) || ((sin(pi/2) > 0.9) && (cos(0) > 0.5))",
                True,
            ),
            # Complex combination of arithmetic, comparison, and trigonometric functions
            (
                "(2 ** 3 == 8) ? ((4 * 5 > 15) && (30 / 6 <= 5)) : ((sqrt(16) == 4) || (log10(100) != 2))",
                True,
            ),
    ...
    def test_cond_expression_parse_to_model_call_without_variables(
        self, expr_text, expected_value
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="cond_expression")
        expr = parse_expr_node_to_expr(ast_node)
    ...
    @pytest.mark.parametrize(
        ["expr_text", "a", "b", "c", "expected_value"],
        [
            ...
            (
                ...
                67,
                -74.44776119402985,
            ),  # Product of a and b, divided by c
            ...
            (
                ...
                61,
                37,
                23956490147809644945650599739257499248964335447281388226410457516241,
            ),
            ...
            (
                ...
                59,
                -2629,
            ),  # a left-shifted by b bits, bitwise OR with c
            ...
            (
                ...
                -80,
                -3,
            ),  # Remainder when sum of a and b is divided by c plus 1
            (
                "sqrt(a**2 + b**2) - c",
                35,
                65,
                -81,
                154.824115301167,
            ),  # Pythagorean calculation of a and b, minus c
            ("log(a) * exp(b) / log10(c)", 49, 47, 52, 5.854304377385308e20),
            ...
            (
                ...
                -7,
                -66,
            ),  # c if a is greater than b, otherwise a plus b
            (
                "(a == b) ? a * c : b - c",
                -57,
                5,
                92,
                -87,
            ),  # a times c if a equals b, otherwise b minus c
            ...
            (
                "log2(a) * (b << 3) + (c & 0xFF) - round(sin(a * pi))",
                67,
                9,
                17,
                453.7584217129596,
            ...
            (
                "sin(a) * cos(b) * tan(c) + sqrt(a**2 + b**2 + c**2)",
                -83,
                -63,
                -82,
                132.91202185631857,
            ...
            (
                "floor(sqrt(a**2 + b**2)) * ceil(log(c + 1)) + round(sin(a * b * c))",
                13,
                72,
                82,
                365,
            ...
            (
                "(a ** b % c) * ((a << 2) & (b >> 1)) + abs(sin(a) * cos(b) - tan(c))",
                -17,
                -71,
                -69,
                0.41264222158717123,
    ...
    def test_num_expression_parse_to_model_call_with_variables(
        self, expr_text, a, b, c, expected_value
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="num_expression")
        expr = parse_expr_node_to_expr(ast_node)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                51,
                True,
            ),  # a is not equal to b AND c is greater than 0
            (
                "!(a == b) && c > 0",
                12,
                -32,
            ...
            (
                ...
                7,
                True,
            ),  # a equals b OR b equals c OR a equals c
            (
                "a == b || b == c || a == c",
                88,
                88,
            ...
            (
                ...
                56,
                True,
            ),  # a, b, and c are all non-negative
            (
                "a >= 0 && b >= 0 && c >= 0",
                48,
                23,
            ...
            (
                ...
                13,
                True,
            ),  # If a > b then check if b > c, otherwise check if a > c
            (
                "(a > b) ? (b > c) : (a > c)",
                73,
                57,
            ...
            (
                ...
                -72,
                True,
            ),  # a, b, and c are all even numbers
            (
                "a % 2 == 0 && b % 2 == 0 && c % 2 == 0",
                -24,
                -56,
            ...
            # Nested conditional expression comparing all three variables
            (
                "(a % 2 == 0 && b % 2 == 0) || (a % 2 != 0 && b % 2 != 0) ? c % 2 == 0 : c % 2 != 0",
                98,
                -80,
                -5,
                True,
            ...
            # c is even if a and b are both even or both odd, otherwise c is odd
            (
                "(a > 0 && b > 0 && c > 0) && (a**2 + b**2 == c**2 || b**2 + c**2 == a**2 || a**2 + c**2 == b**2)",
                15,
                20,
                25,
                True,
            ),  # Forms a right triangle (all sides positive and Pythagorean theorem holds for some combination)
            (
                "(a > 0 && b > 0 && c > 0) && (a**2 + b**2 == c**2 || b**2 + c**2 == a**2 || a**2 + c**2 == b**2)",
                32,
                68,
            ...
            (
                ...
                -66,
                True,
            ),  # The three variables can be arranged in non-decreasing order
            (
                "(a <= b && b <= c) || (a <= c && c <= b) || (b <= a && a <= c) || (b <= c && c <= a) || (c <= a && a <= b) || (c <= b && b <= a)",
                -99,
                10,
            ...
            (
                ...
                70,
                True,
            ),  # Forms a valid acute triangle (triangle inequality and all angles are acute)
            (
                "(a > 0 && b > 0 && c > 0) && (a + b > c && b + c > a && a + c > b) && (a**2 + b**2 > c**2 && b**2 + c**2 > a**2 && a**2 + c**2 > b**2)",
                91,
                78,
            ...
            (
                ...
                48,
                True,
            ),  # All values are different, and there is both a maximum and minimum value
            (
                "!(a == b || b == c || a == c) && ((a > b && a > c) || (b > a && b > c) || (c > a && c > b)) && ((a < b && a < c) || (b < a && b < c) || (c < a && c < b))",
                35,
                48,
            ...
            (
                ...
                -41,
                True,
            ),  # Complex parity relationship between variables
            (
                "((a % 2 == 0) ? b % 2 == 0 : c % 2 == 0) && ((b % 2 == 0) ? a % 2 == 0 : c % 2 == 0) && ((c % 2 == 0) ? a % 2 == 0 : b % 2 == 0)",
                -8,
                66,
            ...
            (
                "(a > 0 && b > 0 && c > 0) && (a**2 + b**2 + c**2 >= 2 * (a*b + b*c + a*c))",
                6,
                5,
                62,
                True,
            ...
            (
                ...
                -49,
                True,
            ),  # Highly nested conditional expression with complex inequality relationships
            (
                "(a > b) ? ((b > c) ? ((a > c) ? a > b + c : a < b + c) : ((a > c) ? b < a + c : b > a + c)) : ((a > c) ? ((b > c) ? a < b + c : a > b + c) : ((b > c) ? a + c > b : a + c < b))",
                5,
                55,
    ...
    def test_cond_expression_parse_to_model_call_with_variables(
        self, expr_text, a, b, c, expected_value
    ):
        ast_node = parse_with_grammar_entry(expr_text, entry_name="cond_expression")
        expr = parse_expr_node_to_expr(ast_node)
