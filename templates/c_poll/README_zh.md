...
5. 修改 runtime template 时，生成代表性 machine，并运行 C99 build checks、C++98 integration checks、formatter convergence checks、c_poll-specific event-check tests 和 simulator-alignment tests。
