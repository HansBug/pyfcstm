...
Run `049e0c4b9ef7`, candidate `049e0c4b9ef7`.
...
|---|---|---|---|---|---|
| `cross_step` | `formal` | 1.8 | 1.8 | 23.3 | 29.5 |
| `definedness` | `proof` | 1.5 | 1.5 | 13.1 | 17.7 |
| `empty_interval` | `proof` | 1.8 | 1.8 | 17.0 | 22.8 |
| `event_conflict` | `formal` | 1.7 | 1.8 | 13.1 | 13.2 |
| `feasible` | `none` | 1.8 | 1.8 | 1.7 | 1.8 |
| `state_domain` | `proof` | 1.6 | 1.6 | 20.7 | 32.0 |
| `two_states` | `proof` | 1.8 | 1.8 | 16.1 | 21.3 |
| `two_values` | `proof` | 1.7 | 1.7 | 16.2 | 21.8 |
...
|---|---|---|---|---|
| `cross_step` | - | - | - | - |
| `definedness` | `definedness_failure`, `source_fact` | 3 | 2 | `core_binding`x2, `rule_checker`x1 |
| `empty_interval` | `interval_intersection`, `source_fact` | 3 | 2 | `core_binding`x2, `rule_checker`x1 |
| `event_conflict` | - | - | - | - |
| `feasible` | - | - | - | - |
| `state_domain` | `source_fact`, `state_domain_exhaustion` | 6 | 5 | `core_binding`x5, `rule_checker`x1 |
| `two_states` | `incompatible_equalities`, `source_fact` | 3 | 2 | `core_binding`x2, `rule_checker`x1 |
| `two_values` | `incompatible_equalities`, `source_fact` | 3 | 2 | `core_binding`x2, `rule_checker`x1 |

Rules the corpus reaches: `definedness_failure`, `incompatible_equalities`, `interval_intersection`, `source_fact`, `state_domain_exhaustion`.
...
```bash
python tools/run_bmc_infeasibility_benchmark.py --rebuild 049e0c4b9ef7
```
