...
class TestDSLCondition:
    @pytest.mark.parametrize(
        ...
        [
            (
                "def int x = 5;",
                DefAssignment(name="x", type="int", expr=Integer(raw="5")),
            ),
            # Simple integer definition with literal value
            (
                "def int counter = 0;",
                DefAssignment(name="counter", type="int", expr=Integer(raw="0")),
            ),
            ...
            (
                "def float y = 3.14;",
                DefAssignment(name="y", type="float", expr=Float(raw="3.14")),
            ),
            # Simple float definition with decimal value
            (
                "def float pi_value = 3.14159;",
                DefAssignment(name="pi_value", type="float", expr=Float(raw="3.14159")),
            ),
            ...
            (
                ...
                DefAssignment(
                    name="negative_float",
                    type="float",
                    expr=UnaryOp(op="-", expr=Float(raw="2.5")),
                ),
            ),
            # Float definition with negative value
            (
                "def float scientific = 1.5e3;",
                DefAssignment(name="scientific", type="float", expr=Float(raw="1.5e3")),
            ),
            # Float definition using scientific notation
            (
                "def float tiny = 1.5e-4;",
                DefAssignment(name="tiny", type="float", expr=Float(raw="1.5e-4")),
            ),
            # Float definition using negative exponent
            (
                "def int hex_value = 0x1A;",
                DefAssignment(name="hex_value", type="int", expr=HexInt(raw="0x1A")),
            ),
            # Integer definition using hexadecimal notation
            (
                "def int hex_large = 0xFFFF;",
                DefAssignment(name="hex_large", type="int", expr=HexInt(raw="0xFFFF")),
            ),
            # Integer definition with larger hex value
            (
                "def float pi_const = pi;",
                DefAssignment(name="pi_const", type="float", expr=Constant(raw="pi")),
            ),
            # Float definition using pi constant
            (
                "def float e_const = E;",
                DefAssignment(name="e_const", type="float", expr=Constant(raw="E")),
            ),
            # Float definition using E constant
            (
                "def float tau_const = tau;",
                DefAssignment(name="tau_const", type="float", expr=Constant(raw="tau")),
            ),
            ...
            (
                ...
                DefAssignment(
                    name="positive",
                    type="int",
                    expr=UnaryOp(op="+", expr=Integer(raw="15")),
                ),
            ),
            ...
            (
                "def int difference = 10 - 4;",
                DefAssignment(
                    name="difference",
                    type="int",
                    expr=BinaryOp(
                        expr1=Integer(raw="10"), op="-", expr2=Integer(raw="4")
                    ),
                ),
            ),
            # Integer definition with subtraction
            (
                "def float product = 2.5 * 3.0;",
                DefAssignment(
                    name="product",
                    type="float",
                    expr=BinaryOp(
                        expr1=Float(raw="2.5"), op="*", expr2=Float(raw="3.0")
                    ),
                ),
            ),
            # Float definition with multiplication
            (
                "def float quotient = 10.0 / 2.0;",
                DefAssignment(
                    name="quotient",
                    type="float",
                    expr=BinaryOp(
                        expr1=Float(raw="10.0"), op="/", expr2=Float(raw="2.0")
                    ),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    ...
                    type="float",
                    expr=BinaryOp(
                        expr1=Float(raw="2.0"), op="**", expr2=Float(raw="3.0")
                    ),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    ...
                    type="int",
                    expr=BinaryOp(
                        expr1=Integer(raw="1"), op="<<", expr2=Integer(raw="3")
                    ),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    ...
                    type="int",
                    expr=BinaryOp(
                        expr1=Integer(raw="16"), op=">>", expr2=Integer(raw="2")
                    ),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    ...
                    expr=BinaryOp(
                        ...
                        expr2=Paren(
                            expr=BinaryOp(
                                expr1=Float(raw="3.0"), op="+", expr2=Float(raw="1.0")
                            )
                        ),
                    ),
                ),
            ...
            (
                ...
                DefAssignment(
                    name="sine",
                    type="float",
                    expr=UFunc(func="sin", expr=Float(raw="0.5")),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    name="sqrt_val",
                    type="float",
                    expr=UFunc(func="sqrt", expr=Float(raw="16.0")),
                ),
            ),
            ...
            (
                ...
                DefAssignment(
                    name="log_val",
                    type="float",
                    expr=UFunc(func="log", expr=Float(raw="100.0")),
                ),
            ),
            # Float definition using logarithm function
            (
                "def float abs_val = abs(-15.0);",
                DefAssignment(
                    name="abs_val",
                    type="float",
                    expr=UFunc(
                        func="abs", expr=UnaryOp(op="-", expr=Float(raw="15.0"))
                    ),
                ),
            ),
    ...
    def test_positive_cases_str(self, input_text, expected_str):
        assert (
            str(parse_with_grammar_entry(input_text, entry_name="def_assignment"))
            == expected_str
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                'def string name = "John";',
            ),  # Invalid type 'string' not supported in grammar
            ...
            (
                "def float invalid_func = notAFunction(5.0);",
            ),  # Using undefined function
            ("def float missing_arg = sin();",),  # Missing argument in function call
            (
                "def float extra_args = sin(1.0, 2.0);",
            ),  # Too many arguments in function call
            (
                "def int comparison = 5 > 3;",
            ),  # Boolean comparison not allowed in init_expression
            (
                "def int logical = true && false;",
            ),  # Logical operation not allowed in init_expression
            (
                "def int conditional = (5 > 3) ? 1 : 0;",
            ),  # Conditional expression not allowed in init_expression
            (
                "def int wrong_assign := 10;",
            ),  # Using ':=' instead of '=' for definition
            (
                "def int a = 1, b = 2;",
            ),  # Multiple definitions not allowed in one statement
            (
                "def float incomplete = sin 0.5;",
