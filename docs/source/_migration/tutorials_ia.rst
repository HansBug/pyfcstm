...
.. csv-table:: Old DSL resource directives
   ...
   L1426,literalinclude,guards_and_effects.fcstm,Complete Example,how_to/dsl guards/effects and reference/dsl operation blocks,kept as literalinclude,pyfcstm inspect where file is a full model
   ...
   L1798,literalinclude,expression_demo.fcstm,Complete Expression Example,how_to/dsl expressions and reference/dsl expression reference,kept as literalinclude,pyfcstm inspect where file is a full model
