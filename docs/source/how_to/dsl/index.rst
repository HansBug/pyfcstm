...
* Stable label: ``sec-how-to-dsl``

Current authority
-----------------

The current authoritative content remains in :doc:`../../tutorials/dsl/index`.

Task-focused DSL material such as imports, event scopes, and guards will move here.
