...
class TestDSLTransition:
    @pytest.mark.parametrize(['input_text', 'expected'], [
        ...
        (
                ...
                """,
                StateDefinition(name='SimpleState', substates=[], transitions=[], enters=[], durings=[], exits=[],
        ...
        (
                ...
                """,
                StateDefinition(name='ComplexState', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='ParentState', substates=[
                    StateDefinition(name='ChildState', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                    during_aspects=[], force_transitions=[], is_pseudo=True)], transitions=[],
        ...
        (
                ...
                pseudo state S1 { [*] -> S2; }
                """,
                StateDefinition(name='S1', substates=[], transitions=[
                    TransitionDefinition(from_state=INIT_STATE, to_state='S2', event_id=None, condition_expr=None,
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[
                    TransitionDefinition(from_state='S2', to_state='S3',
                                         event_id=ChainID(path=['chain', 'id'], is_absolute=False), condition_expr=None,
                                         post_operations=[])], enters=[], durings=[], exits=[], during_aspects=[],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                pseudo state S1 { ! S2 -> S3; }
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[], force_transitions=[
                        ForceTransitionDefinition(from_state='S2', to_state='S3', event_id=None, condition_expr=None)],
                                is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[], force_transitions=[
                        ForceTransitionDefinition(from_state='S2', to_state=EXIT_STATE, event_id=None,
                                                  condition_expr=None)], is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[], force_transitions=[
                        ForceTransitionDefinition(from_state=ALL, to_state='S3', event_id=None, condition_expr=None)],
                                is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[
                    ExitOperations(operations=[OperationAssignment(name='y', expr=Integer(raw='20'))], name=None)],
                                during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[
                    DuringOperations(aspect=None, operations=[OperationAssignment(name='z', expr=Integer(raw='30'))],
                                     name=None)], exits=[], during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[],
                                enters=[EnterAbstractFunction(name='func1', doc=None)], durings=[], exits=[],
                                during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[],
                                exits=[ExitAbstractFunction(name='func2', doc=None)], during_aspects=[],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[],
                                durings=[DuringAbstractFunction(name='func3', aspect=None, doc=None)], exits=[],
                                during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[DuringAspectOperations(aspect='before', operations=[
                                    OperationAssignment(name='x', expr=Integer(raw='1'))], name=None)],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[DuringAspectOperations(aspect='after', operations=[
                                    OperationAssignment(name='y', expr=Integer(raw='2'))], name=None)],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[
                                    DuringAspectAbstractFunction(name='aspectFunc', aspect='before', doc=None)],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                during_aspects=[
                                    DuringAspectAbstractFunction(name='aspectFunc', aspect='after', doc=None)],
                                force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='Machine', substates=[
                    StateDefinition(name='Running', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                    during_aspects=[], force_transitions=[], is_pseudo=True),
                    StateDefinition(name='Idle', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                    during_aspects=[], force_transitions=[], is_pseudo=True)], transitions=[
                    TransitionDefinition(from_state='Running', to_state='Idle', event_id=None,
                                         condition_expr=BinaryOp(expr1=Name(name='power'), op='==',
                                                                 expr2=Integer(raw='0')), post_operations=[])],
                                enters=[], durings=[], exits=[], during_aspects=[], force_transitions=[],
                                is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='Parent', substates=[StateDefinition(name='Child1', substates=[], transitions=[],
                                                                          enters=[EnterOperations(operations=[
                                                                              OperationAssignment(name='init',
                                                                                                  expr=Integer(
                                                                                                      raw='1'))],
                                                                              name=None)],
                                                                          durings=[], exits=[], during_aspects=[],
                                                                          force_transitions=[], is_pseudo=True),
                                                          StateDefinition(name='Child2', substates=[], transitions=[],
                                                                          enters=[], durings=[], exits=[ExitOperations(
                                                                  operations=[OperationAssignment(name='cleanup',
                                                                                                  expr=Integer(
                                                                                                      raw='1'))],
                                                                  name=None)], during_aspects=[], force_transitions=[],
                                                                          is_pseudo=True)], transitions=[], enters=[],
                                durings=[], exits=[], during_aspects=[], force_transitions=[], is_pseudo=True)
        ...
        (
                ...
                """,
                StateDefinition(name='S1', substates=[
                    StateDefinition(name='NormalChild', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                    during_aspects=[], force_transitions=[], is_pseudo=False),
                    StateDefinition(name='PseudoChild', substates=[], transitions=[], enters=[], durings=[], exits=[],
                                    during_aspects=[], force_transitions=[], is_pseudo=True)], transitions=[],
                                enters=[], durings=[], exits=[], during_aspects=[], force_transitions=[],
                                is_pseudo=True)
        ...
        (
                ...
                StateDefinition(name='S1', substates=[
                    ...
                    TransitionDefinition(from_state='S2', to_state='S3', event_id=None, condition_expr=None,
                                         post_operations=[]),
                    TransitionDefinition(from_state='S3', to_state='S2', event_id=None, condition_expr=None,
                                         post_operations=[])], enters=[], durings=[], exits=[], during_aspects=[],
                                force_transitions=[], is_pseudo=True)
