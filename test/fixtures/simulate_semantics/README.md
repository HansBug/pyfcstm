...
| `abstract_handler_raise_mode_blocks_later_cycles` | simulation | cycle_count, ended, error_info, error_state, handler_calls, raises, return, stack, state, vars | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614012639) |
| `aspect_context_reports_active_leaf` | simulation | handler_calls, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[issue #156 comment](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4632446687) |
...
| `expression_large_integer_safe_diagnostics` | simulation | cycle_result, history, state, vars | `test/simulate/test_runtime_expression_diagnostics.py::test_large_integer_cycle_does_not_depend_on_disabled_debug_logging`<br>`test/simulate/test_runtime_expression_diagnostics.py::test_large_integer_cycle_uses_safe_debug_logging`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4633784802) |
| `expression_logical_and_short_circuits_in_guard` | simulation | cycle_result, history, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4632515679) |
| `expression_logical_and_short_circuits_in_if` | simulation | cycle_result, history, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4632515679) |
| `expression_logical_or_short_circuits_in_guard` | simulation | cycle_result, history, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4632515679) |
| `expression_logical_or_short_circuits_in_if` | simulation | cycle_result, history, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4632515679) |
| `expression_type_error_wraps_transition_effect` | simulation | raises, history, stack, state, vars | `test/simulate/test_runtime_expression_diagnostics.py::test_transition_effect_type_error_is_wrapped_and_rolls_back`<br>[source](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4631787793) |
...
| `failed_initial_cycle_preserves_root_entry_lifecycle` | simulation, generated_python_alignment | cycle_count, ended, return, stack, state, vars | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614005134) |
| `failed_initial_cycle_skips_abstract_handler_callbacks` | simulation, generated_python_alignment | cycle_count, ended, handler_calls, return, stack, state, vars | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614005134) |
...
| `hot_start_leaf_defers_during_expression_error` | simulation, generated_python_alignment | exception | [PR comment](https://github.com/HansBug/pyfcstm/pull/153#issuecomment-4627323375) |
...
| `lifecycle_action_ref_multi_node_cycle_raises_diagnostic` | simulation | exception | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614298619) |
| `lifecycle_action_ref_two_node_cycle_raises_diagnostic` | simulation | exception | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614298619) |
| `named_ref_context_reports_callsite` | simulation | handler_calls, state, vars | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[issue #156 comment](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4634004004) |
...
| `ref_abstract_handler_reports_calling_state` | simulation, generated_python_alignment | cycle_count, ended, handler_calls, return, stack, state, vars_exact | [issue #143 comment](https://github.com/HansBug/pyfcstm/issues/143#issuecomment-4614012639) |
| `ref_context_uses_callsite_stage` | simulation | handler_calls, stack, state, vars_exact | `test/simulate/test_semantic_fixtures.py::test_simulation_semantic_fixture`<br>[issue #156 comment](https://github.com/HansBug/pyfcstm/issues/156#issuecomment-4631761534) |
